...
- expected tools: `glob`, `read`, file-edit tools, validation commands such as `skills-ref validate` when available
...
- expected tools: `read`, `glob`, file-edit tools, validation commands such as `skills-ref validate` when available
